...
Prática java06 no Repl.it:

- Faça login em sua conta no Repl.it 
- Acesse o menu Teams e clique na prática java06
- Siga as instruções a seguir


### TransacoesBancarias

- Analise o código de TransacoesBancarias.java e identifique qual é o saldo inicial, quais são os depósitos e retiradas, e qual é saldo final esperado após todos os depósitos e retiradas.
...
- Corrija o problema, usando syncrhonized na classe Conta (quais são os métodos que devem ser "protegidos" com exclusão mútua?).
